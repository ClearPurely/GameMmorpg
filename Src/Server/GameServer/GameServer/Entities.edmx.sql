...
-- --------------------------------------------------
-- Date Created: 05/21/2022 01:51:05
-- Generated from EDMX file: D:\biancheng\unity\MyMmorpg\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_CharacerItem]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CharacterItems] DROP CONSTRAINT [FK_CharacerItem];
GO
...
ALTER TABLE [dbo].[CharacterItems]
ADD CONSTRAINT [FK_CharacerItem]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CharacerItem'
CREATE INDEX [IX_FK_CharacerItem]
